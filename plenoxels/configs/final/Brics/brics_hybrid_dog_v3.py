config = {
 'expname': 'dog_v3_hybrid',
 'logdir': './logs/realdynamic',
 'device': 'cuda:0',
 'start_t': 50,
 'num_t': 50,
 # Run first for 1 step with data_downsample=4 to generate weights for ray importance sampling
 # Use downsample=2 for BRICS to generate weights for ray importance sampling
 'data_downsample': 1,
 'data_dirs': ['/gpfs/data/ssrinath/projects/brics_dyscene/dynamic_1/brics-tools/assets/objects/dog/dynamic_data'],
 'contract': True,
 'ndc': False,
 'ndc_far': 2.6,
 'near_scaling': 0.95,
