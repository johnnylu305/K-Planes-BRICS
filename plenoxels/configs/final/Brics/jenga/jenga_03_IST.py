config = {
'expname' : 'jenga_03_IST',
'logdir' : ['/oscar/data/ssrinath/projects/brics_dyscene/dynamic_1/brics-tools/assets/objects/jenga/dynamic_data/kplanes'],
'device' : 'cuda:0',
'start_t' : 450,
'num_t' : 96,
'data_downsample' : 2,
'data_dirs' : ['/oscar/data/ssrinath/projects/brics_dyscene/dynamic_1/brics-tools/assets/objects/jenga/dynamic_data'],
'contract' : True,
'ndc' : False,
'ndc_far' : 2.6,
'near_scaling' : 0.95,
