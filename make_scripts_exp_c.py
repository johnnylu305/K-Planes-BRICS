...
if __name__=="__main__":
    ...
    objects = [f"battery_{res}", f"bunny_{res}", f"clock_{res}", f"music_box_{res}", f"scissor_{res}", f"horse_{res}", f"hour_glass_{res}", f"wolf_{res}", f"world_globe_{res}"]
    ...
    config_root = os.path.join('plenoxels', 'configs_exp_c', 'final', 'Brics', res)
    ...
    for obj in objects:
        ...
        root = os.path.join('brics_scripts_exp_c', res, obj)
